...
class RGBDVisionImuFrontend : public VisionImuFrontend {
 ...
 public:
  RGBDVisionImuFrontend(const ImuParams& imu_params,
                       ...
                       const RgbdCamera::ConstPtr& rgbd_camera,
 ...
 public:
  ...
  void getSmartStereoMeasurements(
      const RgbdFrame::Ptr& RGBDFrame_kf,
      StereoMeasurements* smart_rgbd_measurements) const;
 ...
 private:
  ...
  void processFirstRGBDFrame(const RgbdFrame& firstFrame);
  ...
  StatusRGBDMeasurementsPtr processRgbdFrame(
 ...
 private:
  ...
  // Stereo Frames
  // Current frame
  RgbdFrame::Ptr rgbdFrame_k_;
  // Last frame
  RgbdFrame::Ptr rgbdFrame_km1_;
  // Last keyframe
  RgbdFrame::Ptr rgbdFrame_lkf_;
